...
# Revisión mensual de cambios upstream: Hands-On Programming with R
...
- **Upstream:** `rstudio-education/hopr`, rama `master`
...
`rstudio-education/hopr` rama `master` de los últimos 30 días (desde
...
en la rama `master` de `rstudio-education/hopr`.
